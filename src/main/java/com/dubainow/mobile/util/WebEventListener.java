...
public class WebEventListener extends TestBase implements WebDriverEventListener {
	...
	public void beforeChangeValueOf(WebElement element, AndroidDriver<MobileElement> driver) {
		System.out.println("Value of the:" + element.toString() + " before any changes made");
	}

	public void afterChangeValueOf(WebElement element, AndroidDriver<MobileElement> driver) {
		System.out.println("Element value changed to: " + element.toString());
	}

	public void beforeClickOn(WebElement element, AndroidDriver<MobileElement> driver) {
		System.out.println("Trying to click on: " + element.toString());
	}

	public void afterClickOn(WebElement element, AndroidDriver<MobileElement> driver) {
	...
	public void beforeFindBy(By by, WebElement element, AndroidDriver<MobileElement> driver) {
		System.out.println("Trying to find Element By : " + by.toString());
	}

	public void afterFindBy(By by, WebElement element, AndroidDriver<MobileElement> driver) {
	...
	public void beforeChangeValueOf(WebElement element, AndroidDriver<MobileElement> driver, CharSequence[] keysToSend) {
		// TODO Auto-generated method stub

	}

	public void afterChangeValueOf(WebElement element, AndroidDriver<MobileElement> driver, CharSequence[] keysToSend) {
		// TODO Auto-generated method stub
